...
export const calendarsElements = {	
  elemButtonRight: calendar.querySelector('.button__right'),
  elemButtonLeft: calendar.querySelector('.button__left'),
  ...
  hourContainer: calendar.querySelector('.hour__container'),
};
